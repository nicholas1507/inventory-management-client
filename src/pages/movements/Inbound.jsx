...
import {getMovements, createMovement, getProducts, getSuppliers} from '../../api/api';
import { useAuth } from "../../contexts/AuthContext";
import { CButton } from "@coreui/react";
import InboundModal from '../../components/movements/InboundModal';
...
const Inbound = () => {
    ...
    const loadMovements = async(page = 1, keyword = "") => {
        ...
        setError(null);
        try{
            const data = await getMovements({page,limit: pagination.limit, search: keyword, type: "IN"});
    ...
    const load = async() => {
        ...
        try{
            ...
            setSuppliers(Array.isArray(suppliers) ? suppliers : suppliers.data);
        }catch(error){
    ...
    const handleSubmit = async(payload) => {
        ...
        await loadMovements(currentPage,search);
    }
