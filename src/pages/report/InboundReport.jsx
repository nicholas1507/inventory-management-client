...
const InboundReport = () => {
    ...
    const load = async(page = 1, keyword = "", start = "", end = "") => {
        ...
        setError(null);
        try{
            const data = await getMovements({page, limit: pagination.limit, search: keyword, type: "IN", startDate: start, endDate: end});
    ...
    return(
        <div>
            ...
            <div className="card mb-3">
                <div className="card-body">
                    <div className="card-title">List Inbound Report</div>
