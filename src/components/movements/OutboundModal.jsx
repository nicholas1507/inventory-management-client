...
const OutboundModal = ({ visible, setVisible, onSubmit, products, customers }) => {
    const createItem = () => ({
    ...
    const handleChange = (index, field, value) => {
        ...
        nowItems[index][field] = field === 'quantity' ? parseInt(value) || 1 : value;
        setItems(nowItems);
    }
    const addRow = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const emptyProduct = items.some(i => !i.productId);
        if (emptyProduct || !customerId) {
